<%-- 
    Document   : navBarAfLoginLeader
    Created on : Oct 24, 2020, 2:52:52 PM
    Author     : DELL
--%>
...
<html>
    ...
    <body>
        ...
        <c:if test="${not empty sessionScope.USER}"> 
            ...
            <c:url value="MainController" var="linkViewCartMember">
                <c:param name="action" value="viewCartMember"/>
            </c:url>
            <c:url value="MainController" var="linkManageGroup">
                <c:param name="action" value="ManageGroup"/>
                <c:param name="userID" value="${sessionScope.USER.userID}"/>
            </c:url>
            <c:url value="MainController" var="linkCreateGroup">
                <c:param name="action" value="FormCreateGroup"/>
            </c:url>
            ...
            <c:url value="MainController" var="linkCreateEvent">
                <c:param name="action" value="Form Create Event"/>
            </c:url>
            <nav class="navbar navbar-expand-sm bg-light navbar-light" > 
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="${linkViewCartMember}">View to cart(Group)</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="${linkCreateGroup}">Create Group</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="${linkCreateEvent}">Create Event</a>
                    </li>
                    <li class="nav-item">
