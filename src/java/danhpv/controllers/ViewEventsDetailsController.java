 ...
 * @author DELL
 */
public class ViewEventsDetailsController extends HttpServlet {

    private static final String ERROR = "error.jsp";
    private static final String SUCCESS = "viewEvent_Details.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<TblComment> listComment = commentBlo.getListMemberAdd(eventID);
            if (listComment.size() > 0) {
                request.setAttribute("LIST_COMMENT", listComment);
            }
        } catch (Exception e) {
            log("Error at ViewEventDetailsController: " + e.getMessage());
            url = ERROR;
        } finally {
